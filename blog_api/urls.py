...
from . views import HomeView, LoginView, ContactView, RecipeView,  SliderView, SocialLinkView, FooterImageView,FeatureView, NewsletterView,AddressView,CommentsView, RatingView,RecipePostView,CommentListView
